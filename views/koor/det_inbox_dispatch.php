<!-- Modal -->
			<div class="modal fade" id="modal_dispatch">
        		...
        		<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        				<h3 class="modal-title">Dispatch Ke Staff</h3>
      						</div>
		...
		<div id="main_wrapper">
			...
			<div class="row">
			    <div class="col-sm-12 text-left"> 
			    	<a href="<?php echo base_url();?>index.php/koor/inbox_dispatched"><span class="fa fa-lg fa fa-arrow-left"></span> Back To Inbox </a>
			    </div>
			   </div> 
			</div>
