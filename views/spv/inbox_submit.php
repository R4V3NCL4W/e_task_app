...
<!-- Bootstrap modal -->
  <div style="display:none;">     
    <div class="form" id="submit_form">
        ...
        <?php echo form_open_multipart('spv/update_spv',array('class'=>'cmxform form-horizontal tasi-form','id'=>'commentForm'));?>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <select name="status" class="form-control" id="status">
					<option value="SP: COMPLETE">Complete</option>
             ...
             <div class="form-group"  id="nilai">
              <label class="control-label col-md-3">Kepuasan</label>
              <div class="col-md-9">
...
<!-- main content -->
		<div id="main_wrapper">
			...
			<div class="row">
			    <div class="col-sm-12 text-left"> 
			    	<a href="<?php echo base_url();?>index.php/spv/inbox_tugas"><span class="fa fa-lg fa fa-arrow-left"></span> Back To Inbox </a>
			    </div>
			   </div> 
			</div>
			<div class="page_content">
				<div class="container-fluid">
					<div class="panel panel-default" style="background-color:#DFE1E3;">
						...
						<div class="row">
								<div class="col-md-7 text-right"> 
								    <a  href="#submit_form" class="submit_tugas"><button type="button" class="btn btn-success btn-md"><span class="fa fa fa-share"></span> Accept Task </button></a>
								</div>
							</div>
					</div>
				</div>
		...
		$(document).ready(function(){
			$('#status').on('change',function(){
				...
				if ( status == 'SP: COMPLETE'){
					$("#nilai").show('highlight');
				}
				else {
					$("#nilai").hide();
				}
